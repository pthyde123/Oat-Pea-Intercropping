...
plot_increase <- read_csv("data/plot_increase _randomization.csv") %>% 
  mutate(plots_to_plant =1) %>% 
...
headrow_increase <- read_csv("data/headrow_increase _randomization.csv") %>% 
...
winterOatPea_2025_plot_HR <- read_csv("data/winterOatPea_2025_plot_HR.csv") %>% 
